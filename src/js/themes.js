/**
 * Default light/dark theme CSS-custom-property strings, used by the
 * theme editor ("#theme" section) to prefill the textarea. Pure data,
 * no DOM/jQuery - trivially portable, only `export` keywords added.
 */
